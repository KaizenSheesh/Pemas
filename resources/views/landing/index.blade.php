    ...
    <div class="container">
        <div class="uk-margin-medium-top">
            <ul class="uk-flex-center uk-tab-bottom" uk-tab>
                ...
                <li><a class="text-decoration-none" href="#tab3">Pengaduan Berhasil</a></li>
            </ul>
        </div>
                ...
                <form action="">
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <input class="uk-input" id="Judul" type="text" placeholder="Tuliskan Disini!">
                        </div>
                    </div>
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <textarea class="uk-textarea" rows="5" id="Isi-pengaduan" placeholder="Tuliskan disini!" aria-label="Textarea"></textarea>
                        </div>
                    </div>

                    <div class="uk-margin">
                        <label class="uk-form-label" for="Penulis">Penulis</label>
                        <div class="uk-form-controls">
                            <input class="uk-input" id="Penulis" type="text" placeholder="Tuliskan Disini!">
                        </div>
                    </div>
